...
while True:
 ...
 if retL and retR:
  ...
  cv_file_out.write("preFilterSize", preFilterSize)
  cv_file_out.write("preFilterCap", preFilterCap)
  cv_file_out.write("textureThreshold", textureThreshold)
  cv_file_out.write("uniquenessRatio", uniquenessRatio)
  cv_file_out.write("speckleRange", speckleRange)
  cv_file_out.write("speckleWindowSize", speckleWindowSize)
  cv_file_out.write("disp12MaxDiff", disp12MaxDiff)
  cv_file_out.write("minDisparity", minDisparity)
  cv_file_out.release()
